...
import com.ttlabz.pombo.infra.rate_limiting.IpRateLimiter
import com.ttlabz.pombo.infra.rate_limiting.IpResolver
...
class IpRateLimitInterceptor(
    ...
    @param:Value("\${pombo.rate-limit.ip.apply-limit}")
