...
class EmailService(
    ...
    @param:Value("\${pombo.email.from}")
    private val emailFrom: String,
    @param:Value("\${pombo.email.url}")
    ...
    fun sendVerificationEmail(
        ...
        sendHtmlEmail(
            to = email,
            subject = "Verify you Pombo Account",
            html = htmlContent
        )
    }
    ...
    fun sendPasswordResetEmail(
        ...
        val resetPasswordUrl = UriComponentsBuilder
            .fromUriString("$baseUrl/api/v1/auth/reset-password")
            .queryParam("token", token)
            .build()
            .toUriString()
        ...
        sendHtmlEmail(
            to = email,
            subject = "Reset your Pombo password",
            html = htmlContent
        )
    }
