package com.ttlabz.pombo.infra.push_notification
...
import com.ttlabz.pombo.domain.model.PushNotificationSendResult
...
class FirebasePushNotificationService(
    ...
    fun initialize() {
        try {
            val serviceAccount = resourcesLoader.getResource(credentialsPath)
                        ...
                        DeviceToken.Platform.ANDROID -> {
                            setAndroidConfig(
                                AndroidConfig.builder()
                                    ...
                                    .setRestrictedPackageName("com.ttlabz.pombo")
                                    .build()
                            )
                        }
